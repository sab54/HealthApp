...
const setup = (overrides = {}) => {
  ...
  // Defaults for AsyncStorage; individual tests can override via mockResolvedValueOnce
...
describe('LoginScreen', () => {
  ...
  it('renders basic UI and prefills from AsyncStorage when available', async () => {
    ...
    const { getByPlaceholderText, getByText, queryByTestId } = setup();

    expect(getByText('Enter phone number to continue')).toBeTruthy();
  ...
  // Updated validation test: assert that pressing while invalid does not dispatch or navigate
